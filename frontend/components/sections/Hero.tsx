  ...
  return (
    <div id='hero' className='relative h-screen max-w-5xl mx-auto flex flex-col p-4 pt-8 lg:pt-32 md:p-16'>
      <div className='flex flex-col md:flex-row items-center relative'>
        ...
        <Image src={img} alt='hero' width={700} height={400} unoptimized={true} className='left-1/4 top-4 mt-16 md:mt-0 md:absolute' priority/>
      </div>
      <Link href='#catlog' className='absolute bottom-24 left-1/2 transform translate-x-1/2 flex flex-row items-center px-6 py-2 mx-auto mb-16 mt-auto border border-slate-400 rounded-xl text-sm text-slate-400'>
      <MdKeyboardDoubleArrowDown className='w-4 h-4 mr-2 animate-ping'/>
      <span>Click to Scroll</span>
      <MdKeyboardDoubleArrowDown className='w-4 h-4 mr-2 animate-ping'/></Link>
    </div>
  )
}
