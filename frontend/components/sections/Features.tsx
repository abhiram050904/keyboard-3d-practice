...
const Features = () => {
  return (
    ...
    <h2 className='text-2xl font-semibold pl-4 md:pl-16 pb-16'>Features<span className='animate-pulse'>/ </span></h2>
    <div className='flex flex-wrap items-center justify-center gap-8 max-w-4xl mx-auto'>
      {
        features.map((feature,index)=>(
          <FeatureCard key={index} index={index} title={feature.title} description={feature.description} icon={feature.icon}/>
        ))
      }
    </div>
  </div>
